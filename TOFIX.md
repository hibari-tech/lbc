...
- [2026-05-10] control-plane heartbeat auth — currently uses fingerprint match as the sole credential. Spec §7.4 calls for a short-lived JWT refreshed on each heartbeat. Add JWT issuance + refresh before Phase 1.
